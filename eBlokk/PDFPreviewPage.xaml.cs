...
namespace eBlokk
{
    public partial class PDFPreviewPage : ContentPage
    {
        ...
        private void GenerateAndDisplayPDF()
        {
            ...
            var barcodeNumber = Random.Shared.NextInt64(705000000, 705999999).ToString();
            string barcodeHtml = $@"
                <div class='line'></div>
                <div class='center'>{barcodeNumber}</div>
                <div class='center'>
                    <img src='https://bwipjs-api.metafloor.com/?bcid=code128&text={barcodeNumber}&scaleX=2&scaleY=1&includetext' alt='Vonalkód' />
                </div>";
        ...
        private async void DownloadPDF(object sender, EventArgs e)
        {
            ...
            string barcodeHtml = $@"
                ...
                <div class='center'>{barcodeNumber}</div>
                <div class='center'>
                    <img src='https://bwipjs-api.metafloor.com/?bcid=code128&text={barcodeNumber}&scale=2&includetext' alt='Vonalkód' />
                </div>";
